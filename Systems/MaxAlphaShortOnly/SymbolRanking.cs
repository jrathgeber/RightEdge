...
public class MySystem : MySystemBase
{
	...
	public void saveOutput() {
		...
		string path1 = Path.Combine("C:\\dec\\RightEdge\\Systems\\MaxAlphaShortOnly","output.html");
		sw = new StreamWriter(path1);
	
		string path2 = Path.Combine("C:\\dec\\RightEdge\\Systems\\MaxAlphaShortOnly","output.txt");
